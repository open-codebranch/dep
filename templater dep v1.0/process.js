...
e(".injectHere").innerHTML = `বর্তমানে ${_giverPronoun} অত্র দলিল ${_giverER}র নানা প্রকার বৈধ কারণে নগদ টাকার বিশেষ প্রয়োজন হওয়ায় উপরোল্লিখিত বর্ণিত রূপে অর্জিত নিম্ন তফসিল বর্ণিত সম্পত্তি প্রকাশ্যে সাফ বিক্রয় করার প্রস্তাব ঘোষণা করিলে ${_receiverPronoun} অত্র দলিল ${_receiver} উক্ত ভূমি খরিদ করিতে ইচ্ছুক হওয়ায় ${_giverPronoun} অত্র দলিল ${_giver} ${_receiverPronounR} নিকট বিক্রয় করিতে সম্মত হইয়া বর্ণিত ভূমির সাকূল্য মূল্যের টাকা ${_giverPronoun}  অত্র দলিল ${_giver} নগদ গ্রহণ করিয়া বর্ণিত দাগের সম্পত্তি অত্র সাফ কবলা দলিল দ্বারা ${_receiverPronounR} নিকট সাফ বিক্রয় করিলাম। 
<br>
